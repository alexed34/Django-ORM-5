...
class Flat(models.Model):
    ...
    new_building = models.NullBooleanField("Новостройки")
    ...
    liked_by = models.ManyToManyField(User, related_name='liked_flat', null=True, blank=True, verbose_name="Кто лайкнул")
...
class Complaint(models.Model):
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='user_complaints', verbose_name='Кто жаловался')
    flat = models.ForeignKey(Flat, on_delete=models.CASCADE, related_name='flat_complaints', verbose_name='Квартира, на которую пожаловались')
    text = models.TextField(blank=True, verbose_name='Текст жалобы')


class Owner(models.Model):
    owner = models.CharField("ФИО владельца", max_length=200, null=True, db_index=True)
    ...
    flat = models.ManyToManyField(Flat, related_name='owner_flats', null=True,  verbose_name="Квартиры в собственности", db_index=True)
